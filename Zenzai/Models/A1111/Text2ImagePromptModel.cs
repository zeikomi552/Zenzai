...
{
    public class Text2ImagePromptModel : BindableBase
    {
        ...
        public bool Equals(Text2ImagePromptModel req)
        {
        ...
        /// Commandへセット
        /// </summary>
        public static Text2ImagePromptModel CreateCommandFromImageText(string image_text)
        {
            try
            {
                string[] text = image_text.Split("\n");
                Text2ImagePromptModel ret = new Text2ImagePromptModel();
            ...
            catch (Exception ex)
            {
                ...
                return new Text2ImagePromptModel();
            }
        }
        #endregion
